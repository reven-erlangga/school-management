    ...
    async findAllModules() {
        ...
        const transformedModules = modules.map(module => {
            ...
            const subModules = (module.subModules || []).map(sub => {
                ...
                return { ...sub, config: parsedSubConfig, meta: parsedSubMeta, endpoints: parsedSubEndpoints, forms: parsedSubForms };
            });

            return { ...module, config: parsedConfig, meta: parsedMeta, endpoints: parsedEndpoints, forms: parsedForms, subModules };
        });
